...
public class VanillaRecipes {
	...
	public static final void loadRecipes(){
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.xtremewoodenshovel), new Object[]{
				"PPP",
				"PHP",
				"ESE",
				'H', Items.wooden_shovel, 'P', Blocks.planks, 'S', Items.stick
});
		GameRegistry.addRecipe(new ItemStack(ModItems.xtremestoneshovel), new Object[]{
				"CCC",
				"CHC",
				"ESE",
				'H', Items.stone_shovel, 'C', Blocks.cobblestone, 'S', Items.stick
});
		GameRegistry.addRecipe(new ItemStack(ModItems.xtremeironshovel), new Object[]{
				"III",
				"IHI",
				"ESE",
				'H', Items.iron_shovel, 'I', Items.iron_ingot, 'S', Items.stick
});
		GameRegistry.addRecipe(new ItemStack(ModItems.xtremegoldshovel), new Object[]{
				"GGG",
				"GHG",
				"ESE",
				'H', Items.golden_shovel, 'G', Items.gold_ingot, 'S', Items.stick
});
		GameRegistry.addRecipe(new ItemStack(ModItems.xtremediamondshovel), new Object[]{
				"DDD",
				"DHD",
				"ESE",
				'H', Items.diamond_shovel, 'D', Items.diamond, 'S', Items.stick
});
